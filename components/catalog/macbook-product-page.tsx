...
import type { MacbookCatalogSku } from '@/data/macbook-catalog';
...
export function MacbookProductPage({
  ...
  const product = {
    ...
    configuration: `${selected.color} · Apple ${selected.chip}`,
    price: selected.price,
    image: selected.image,
    href: hrefFor('color', selected.color),
  };
  return (
    <main className="iphone-product-page macbook-product-page">
      <div className="container">
        <Link href="/catalog/macbooks" className="product-back">
          <ArrowLeft size={16} /> Вернуться к MacBook
        </Link>
        <div className="product-layout">
          <section className="product-gallery" aria-label={`Фото ${model}`}>
            <div className="product-gallery-frame macbook-gallery-frame">
              <Image
          ...
          <section className="product-info">
            <p className="catalog-overline">APPLE · MAC</p>
            <h1>{model}</h1>
            <p className="product-lead">
              Выберите память и цвет — цена и конфигурация обновятся
              автоматически.
            </p>
          ...
          <div>
            ...
            <div className="product-delivery-grid">
              ...
              <article>
                <h3>Гарантия</h3>
                <p>
                  Гарантия 12 месяцев. Проверим MacBook и комплектность перед
                  выдачей.
                </p>
              </article>
            </div>
